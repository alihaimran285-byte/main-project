...
import { X, UserPlus, BookOpen, Mail, Phone, Hash, Calendar, Clock, Users, Star } from 'lucide-react';
...
const AddTeacherModal = ({ isOpen, onClose, onSave, loading }) => {
  const [formData, setFormData] = useState({
    ...
    classes: 1,
    experience: 0,
    totalStudents: 0, // ✅ Added students count
...
const handleSubmit = () => {
  ...
  const teacherData = {
    ...
    totalStudents: parseInt(formData.totalStudents) || 0, // ✅ یہاں check کریں
  ...
  console.log('📤 Sending data to server:', teacherData); // ✅ Add this line
